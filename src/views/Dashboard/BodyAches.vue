<template>
    <card header-classes="bg_transparent" class="body-aches">
        <div class="row" slot="header">
            <div class="col">
                <h5 class="h5 mb-0">{{ $t('dashboard.bodyAches') }}</h5>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-15 col-md-8">
                <div class="body-aches-chart" ref="bodyacheschart"></div>
            </div>
        </div>
    </card>
</template>
...
am4core.useTheme(am4themes_material)
    ...
    export default {
        ...
        methods: {
            loadChart() {
                this.chart = am4core.create(this.$refs.bodyacheschart, am4charts.PieChart)

                this.chart.data = this.bodyAches.Stats;
        ...
        computed: {
            bodyAches() {
                return this.$store.getters.getBodyAchesStats
            }
        },
        watch: {
            bodyAches: function(value) {
                this.mild = 0
                this.severe = 0
                this.moderate = 0
...
<style>
.body-aches .card-body {
    padding-left: 10px;
    padding-right: 10px;
    padding-bottom: 0;
}

.body-aches .people-reported {
    font-weight: 300;
    color: black;
}

.body-aches .number-people {
    font-weight: bolder;
    font-size: 30px;
    color: black;
}

.body-aches .option-tag {
    font-size: 11px;
    color: black;
}

.body-aches .option-number-tag {
    color: black;
    font-weight: 500;
    font-size: 21px;
}
